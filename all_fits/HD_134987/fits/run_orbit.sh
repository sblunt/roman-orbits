...
radvel mcmc -s /roman_orbits/all_fits/HD_134987/fits/HD134987_radvel.py --nensembles 8 --burnGR 1.005 --maxGR 1.001 --burnAfactor 200 -d /roman_orbits/all_fits/HD_134987/fits/results
