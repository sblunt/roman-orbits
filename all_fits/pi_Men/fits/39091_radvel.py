...
# -*- coding: utf-8 -*-
"""
Created on 2025-04-09 16:18
Author: calebharada

39091_radvel.py

    Description: RadVel setup file for HD 39091 (pi Men)
"""
...
DATA_PATH = '../data/39091_rv_main_binned.txt'
...
# planet 1
anybasis_params['per1'] = radvel.Parameter(value=2088.8)  # period 
anybasis_params['tp1'] = radvel.Parameter(value=2458388.6)  # time of peri
anybasis_params['e1'] = radvel.Parameter(value=0.642)  # eccentricity 
anybasis_params['w1'] = radvel.Parameter(value=5.76)  # arg of peri 
...
stellar = dict(mstar=1.07, mstar_err=0.04)   # from Hatzes et al. (2022)
