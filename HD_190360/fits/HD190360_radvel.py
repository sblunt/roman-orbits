...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul  4 15:09:57 2024

@author: zhexingli
"""

# Setup file for HD 190360 Radvel fitting
...
anybasis_params['tp1'] = radvel.Parameter(value=2459286)    # time of periastron of 1st planet
anybasis_params['e1'] = radvel.Parameter(value=0.3291)          # eccentricity of 'per tp secosw sesinw k'1st planet
anybasis_params['w1'] = radvel.Parameter(value=0.201)      # argument of periastron of the star's orbit for 1st planet
anybasis_params['k1'] = radvel.Parameter(value=22.74)         # velocity semi-amplitude for 1st planet
anybasis_params['per2'] = radvel.Parameter(value=17.11695)    # period of 2nd planet
anybasis_params['tp2'] = radvel.Parameter(value=2458993.34)    # time of periastron of 2nd planet
anybasis_params['e2'] = radvel.Parameter(value=0.164)          # eccentricity of 'per tp secosw sesinw k' 2nd planet
anybasis_params['w2'] = radvel.Parameter(value=5.723)      # argument of periastron of the star's orbit for 2nd planet
anybasis_params['k2'] = radvel.Parameter(value=5.49)         # velocity semi-amplitude for 2nd planet
...
path = 'path/HD190360_rv_master_binned.txt'
...
priors = [
    ...
    #radvel.prior.HardBounds('jit_AFOE', 0.0, 10.0),
