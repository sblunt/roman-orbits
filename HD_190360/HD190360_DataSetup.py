...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul  3 18:06:33 2024
...
path2 = 'path/SOPHIE_rv_raw.txt'
path3 = 'path/CLS_rv_raw.txt'
savepath = 'path/'
...
# SOPHIE data
data2 = pd.read_csv(path2,header=None,skiprows=1,delim_whitespace=True,\
...
data_all.to_csv(savepath+'HD190360_rv_master_unbinned.txt',sep='\t',index=False, header=True)
...
if binning == 1:
    ...
    data_all_bin.to_csv(savepath+'HD190360_rv_master_binned.txt',sep='\t',index=False, header=True)
